...
Discussion
The original version of #to_s uses String#upcase! which mutates its argument in place. This causes @name to be
modified, which in turn causes name to be modified: this is because @name and name reference the same object 
in memory.
